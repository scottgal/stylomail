...
**Scope:** `src/StyloMail.AccessProxy/` and `tests/StyloMail.AccessProxy.Tests/`. Client access proxy, IMAP/POP3/SMTP session termination with pluggable backend credentials. Design of record: `spec.md` §9.
