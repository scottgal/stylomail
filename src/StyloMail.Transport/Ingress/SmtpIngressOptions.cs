...
public sealed record SmtpIngressOptions
{
    ...
    internal void Validate()
    {
        ...
        // that loops back through this system is not recognised and only the hop limit stops it —
        // a silent failure of the mechanism, discovered as a mail loop. Caught here instead.
