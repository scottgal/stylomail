...
/// safe today and nothing about the type says so, which is the problem: a field added next month, /// a reusable buffer, a cached list, a "last decision" for logging, works perfectly under a single
